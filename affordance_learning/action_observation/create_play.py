...
from create.create_game.constants import *
from create.create_game.base_env import BaseEnv
from create.create_game.tool_gen import ToolGenerator
from create.create_game.tools.tool_factory import ToolTypes
from create.create_game.settings import CreateGameSettings
from create.create_game.create_action_set import get_allowed_actions, gen_action_set, UseSplit

from affordance_learning.action_observation.args import get_args
from affordance_learning.action_observation.action_env_interface import ActionEnvInterface
...
class CreatePlay(gym.Env):
    ...
    def step(self, action_id):
        ...
        for trial_num in range(MAX_NUM_TRIALS):
            ...
            test_obj_pos = np.array([0.25, 0.95])
